...
func (Rdb *Client) OpenCourse(CourseNum string, LeftStu int) (interface{}, error) {
	...
	v, err = c.Do("SADD", "openCourse", CourseNum)
	if err != nil {
		return nil, err
	}
	return v, nil
...
func (Rdb *Client) CloseCourse(CourseNum string) ([]string, error) {
	...
	_, err = c.Do("SREM", "openCourse", CourseNum)
	if err != nil {
		return nil, err
	}
	return students, nil
...
func (Rdb *Client) CourseAddStu(CourseNum string, StuNum string) error {
	...
	defer c.Close()
	//查看课程是否开放
	v, err := c.Do("SISMEMBER", "openCourse", CourseNum)
	if v.(int64) != 1 {
		return errors.New("课程未开放")
	}
...
func (Rdb *Client) CourseDelStu(CourseNum string, StuNum string) (interface{}, error) {
	...
	//课程剩余数加一
	v, err = c.Do("INCRBY", "course"+CourseNum+"LeftStu", 1)
	if err != nil {
		return nil, err
	}
	return v, nil
