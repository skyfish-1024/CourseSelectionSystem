...
func InitRouter() {
	...
	r.Group("/")
	{
		...
		//管理员注册路由
		r.POST("/register/sendmail", v1.RegisterMail)
		r.POST("/register/vc_check", v1.RVCCheck)
		r.POST("/register/set_info", v1.UserInfo)

		//找回密码
		r.POST("/find_pwd/sendmail", v1.BackEmail)
		r.POST("/find_pwd/vc_check", v1.PVCCheck)
		r.POST("/find_pwd/reset_pwd", v1.PasswordReset)
